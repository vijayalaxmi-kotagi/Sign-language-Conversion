...
import io
import pygame  # For playing audio without saving
...
def translate_to_kannada(text):
    try:
        ...
        print("Kannada Translation Error:", e)
...
def translate_to_hindi(text):
    try:
        ...
        print("Hindi Translation Error:", e)
        return "Translation Failed"
...
class Application:
    ...
    def __init__(self):
        ...
        chart_path = "chart.jpg"  # sign language chart
        chart_image = Image.open(chart_path)
        chart_image = chart_image.resize((400, 400))
        chart_photo = ImageTk.PhotoImage(chart_image)

        # Create Label for the chart in the top right corner
        self.chart_label = tk.Label(self.root, image=chart_photo)
        self.chart_label.image = chart_photo  # Keep a reference to prevent garbage collection
        self.chart_label.place(x=1120, y=50)  # Adjust position for top-right placement

        self.panel = tk.Label(self.root)
        self.panel.place(x=100, y=3, width=480, height=640)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=650, y=115, width=400, height=400)

        self.T = tk.Label(self.root)
        self.T.place(x=60, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Cooper black", 30, "bold"))
        ...
        self.T1.config(text="Character :", font=("Cooper black", 20, "bold"))
        ...
        self.T3.config(text="Sentence :", font=("Cooper black", 20, "bold"))

         # Label for "Translated Text :"
        self.T5 = tk.Label(self.root, text="Kannada Text :", font=("Cooper Black", 18, "bold"))
        self.T5.place(x=10, y=680)

        # Label for Kannada translation (place it beside T5)
        self.T3 = tk.Label(self.root, font=("Cooper Black", 18, "bold"))
        self.T3.place(x=280, y=680)  # Adjust x based on how long "Translated Text :" is

        # Label for Hindi translation (below Kannada translation)
        self.T6 = tk.Label(self.root, text="Hindi Text :", font=("Cooper Black", 18, "bold"))
        self.T6.place(x=10, y=722)

        self.T7 = tk.Label(self.root, font=("Cooper Black", 18, "bold"))
        self.T7.place(x=280, y=722)

 
        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=758)
        self.T4.config(text="Suggestions :", fg="red", font=("Cooper black", 20, "bold"))

        # Dropdown List for Language Selection
        self.language_var = tk.StringVar()
        self.language_var.set("English")  # Default selection
        self.language_dropdown = tk.OptionMenu(self.root, self.language_var, "English", "Kannada","Hindi")
        self.language_dropdown.place(x=1350, y=800)  # Adjust position
        self.language_dropdown.config(font=("Cooper black", 20))

        self.b1=tk.Button(self.root)
        self.b1.place(x=50,y=800)

        self.b2 = tk.Button(self.root)
        self.b2.place(x=250, y=800)

        self.b3 = tk.Button(self.root)
        self.b3.place(x=450, y=800)

        self.b4 = tk.Button(self.root)
        self.b4.place(x=650, y=800)

        self.speak = tk.Button(self.root)
        self.speak.place(x=1200, y=800)
        self.speak.config(text="Speak", font=("Cooper black", 20), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=1080, y=800)
        self.clear.config(text="Clear", font=("Cooper black", 20), wraplength=100, command=self.clear_fun)
        
        self.translate_button = tk.Button(self.root)
        self.translate_button.place(x=900, y=800)
        self.translate_button.config(text="Translate", font=("Cooper Black", 20), wraplength=140, anchor="w", justify="left", command=self.translate_text)
        #self.translate_button.grid(row=14, column=12, padx=10, pady=5)
    ...
    def speak_fun(self):
        ...
        if selected_language == "Kannada":
            kannada_text = translate_to_kannada(self.str)
            try:
                ...
                print("Error in Kannada speech:", e)

        elif selected_language == "Hindi":
            hindi_text = translate_to_hindi(self.str)
            try:
    ...
    def clear_fun(self):
        ...
        self.word3 = " "
        self.word4 = " "
        self.T3.config(text="")  # Clear English translation
        self.T3.config(text="")  # Clear Kannada translation
        self.T7.config(text="")  # Clear Hindi   translation
    def translate_text(self):
        kannada_translation = translate_to_kannada(self.str)
        hindi_translation = translate_to_hindi(self.str)

        self.T3.config(text=kannada_translation)
        self.T7.config(text=hindi_translation)
...
app = Application()  # Initialize the Application object
app.root.mainloop()  # Start the Tkinter main loop 
